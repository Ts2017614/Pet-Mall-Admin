  ...
  <div class="content">
    ...
    <div class="container">
      <div class="handle-box">
        ...
        <div>
          <el-button @click="getDataList" type="primary" icon="el-icon-lx-refresh" circle></el-button>
        </div>
      </div>
      <!-- 表格 -->
      <el-table
      ...
      <div class="pagination">
        <Pagination @changeSize="changeSize" @changeCurrent="changeCurrent" :page="page" />
      </div>
    </div>
    <!-- 弹窗 -->
    <el-dialog
      ...
      <el-form ref="menuForm" :rules="addRules" label-width="100px" :model="form">
        ...
        <el-form-item prop="parentId" label="上级目录">
          <el-popover placement="bottom-start" trigger="click" :width="450">
            ...
            <template #reference>
              <el-input clearable readonly v-model="form.parentIdName" placeholder="请选择上级目录"></el-input>
            </template>
          </el-popover>
        </el-form-item>
      </el-form>
